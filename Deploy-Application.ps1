...
Try {
    ...
    [string]$appName = 'GNS 400/500'
    [string]$appVersion = '430W'
    [string]$appArch = ''
    [string]$appLang = 'EN'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Show-InstallationWelcome -CloseApps 'GARMIN 400/W500W Trainer, hsi400wx, G530SIM' -CheckDiskSpace -PersistPrompt
        ...
        If ((Test-Path "$envProgramFilesX86\Garmin") -eq $false) {
			Copy-File -Path "$dirFiles\Garmin" -Destination "$envProgramFilesX86" -Recurse
		}
        ##*===============================================
        ##* POST-INSTALLATION
        ##*===============================================
        ...
        Copy-File -Path "$dirSupportFiles\Garmin" -Destination "C:\ProgramData\Microsoft\Windows\Start Menu\Programs" -Recurse
    ...
    ElseIf ($deploymentType -ieq 'Uninstall') {
        ...
        Show-InstallationWelcome -CloseApps 'GARMIN 400/W500W Trainer, hsi400wx, G530SIM' -CloseAppsCountdown 60
        ...
        If ((Test-Path "$envProgramFilesX86\Garmin") -eq $true) {
			Remove-File -Path "$envProgramFilesX86\Garmin" -Recurse
		}
        ...
        Remove-File -Path "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Garmin" -Recurse
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAcgtrfB6/eJlEl
# d62P/BzTc8wyeIx02Je2MFVWhigcdKCCH8AwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# gjcCAQsxDjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCCmCG9+FQm+k7AB
# 8aVywRu/1xXvQboIg4gFkYnV5qL+cDANBgkqhkiG9w0BAQEFAASCAYB6D/yMHjin
# Ur/0X+UIYC90V8snRmOMWWDbH4JhNHK11cWqbltGEeP5Sst5NOXnKFsXIW9fyD/0
# vcAekSD4B4lY/Y6PdIUI9bkqHpYliijIRdmJw4GPBnwbyvvfDyoZ6sq4Jk/Q2Qto
# MUUtthzGue1YG1eEFq4f5pVGBm6ZJCoJQaIWK57uGwopRekt6JniQt7QLHiI0IpL
# oGGGoz9o4bCyAh0T+pLyFvRlHTcNbedusK0JVOVB4Y36HcRxwWikPPLFfMt5TePE
# AxvbTaEhePnSuDFSCXeXmskszDfjb/3+ucEB7czFPY4snogmaQAXau0VNVmnvF13
# E1nA9ckbzwjjk4/HO/loO+1h9s06Qy0Yt8GrLEjx7pc9Lu3mqZX+InxkKY2ew3mD
# V6xQOmECECQmteTYfHfqQT/pVJjiko5ZOe76ASLOUl30VZ0v/VuWJuWoqtBo8CHG
# NEBo1x66FLBiv5dUwJTBxgSiZkDjob0spyLXUzA+7NmXOdmDQI7OkxChggNLMIID
...
# KoZIhvcNAQkDMQsGCSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMjMwNTE4MTU1
# MDU3WjA/BgkqhkiG9w0BCQQxMgQw/gNgm8zNb5BnOG7277lEm0XalqTBf9p0MAz0
# OwiFzq80YI84WMGIpLGnqYkqPHT2MA0GCSqGSIb3DQEBAQUABIICACrnwhvXQ+cB
# 0rBuPfVnGpmYOnXkkKRFKv5Y3GbS4bd7dr4Q5mjLJHsVPLpKqmLrDJ2+1jN0DEpc
# 3xxzYTsliZoIiwkNwsjnJ5dL7t/qIdkqLv8S8Qxr16NIwAUo3t5bdjBxbk95DneC
# V60Iqt2B7IX1mTjXrDIHufqNhzx38g5viGiUxmxBBPyLRkOFeRCo19cr8u6hz/w4
# H92ezxHfhyO+PH1ORzPcGZ3PlHuVXw0o+VjC/uWfDicq4NHOowPJnRwDpiykaebT
# 3VHrCHe+PvDBErDl8qIg7Bd3/oqH6QLlxbdzoizulHyaseHYR5lLktOz+RWzd5V+
# 99TAt2I+oqICcHsWob4k10NWC6DNP3Q8pvJsxCcoEip9OOK4uKCZ6k3nM9Uvikl8
# 7FXBSV9zxyvCgGvXbQqWujCDXtpD8AojstT1dvBHvhaR9528dOaC4GYx5lyDO7uF
# yypdhdpLUC5DA6CEPdHcy8IhObrIwvASGnKXg8lDFtgk+BbATkSVFb2hmbl+28P7
# rrZwPSnWHZAxt9TODd9awTeqIKIAoSvMivfndG6mi476bpmuasTKupR4IHBU0AU9
# xrfuqJu0ACtIhAX0NwaK9wHF0kuLNPRA+FPCqUYg7JBKzJOOz8Nwa21uk2Ky3R20
# DZbVedt+ebYJThuyfkfPPpH5PEguGxq/
